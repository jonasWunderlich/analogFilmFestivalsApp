 ...
 *
 * @param eventValues: Partial<Projection> data to overwrite default values
 *
 * @example mockProjection({name: 'Hofbauer Kongress'})
 */
export function mockProjection(eventValues: DeepPartial<Projection>): Projection {
  const id = uniqueId();
