...
export const screeningEventAdapter: EntityAdapter<ScreeningEvent> = createEntityAdapter<ScreeningEvent>({
...
export const reducer = createReducer(
  ...
  on(ScreeningEventActions.loadScreeningEventsSucceeded, (state: State, action) => {
  ...
  on(ScreeningEventActions.loadScreeningEventByIdSucceeded, (state: State, action) => {
